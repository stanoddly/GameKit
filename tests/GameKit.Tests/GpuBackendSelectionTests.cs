...
public class GpuBackendSelectionTests
{
    ...
    {
        GpuBackend result = GameKitFactory.ResolveGpuBackend(GpuBackend.Direct3D12, environmentBackend);
    ...
    public void ResolveGpuBackend_WithSupportedEnvironmentOverride_UsesEnvironmentBackend(
        ...
        GpuBackend expected)
    {
        GpuBackend result = GameKitFactory.ResolveGpuBackend(GpuBackend.Automatic, environmentBackend);
    ...
    public void ResolveGpuBackend_WithUnsupportedEnvironmentOverride_Throws()
    {
        InvalidOperationException exception = Assert.Throws<InvalidOperationException>(
            () => GameKitFactory.ResolveGpuBackend(GpuBackend.Automatic, "opengl"))!;

        Assert.That(exception.Message, Does.Contain("GK_GRAPHICS"));
