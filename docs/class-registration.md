...
```csharp
services.AddSingleton(new WindowConfig { Size = (1280, 720) });
...
rootCollection.AddSingleton(new WindowConfig());
...
WindowConfig config = stage.GetRequiredService<WindowConfig>();
